...
% \rightimage{data}{Data.}{0.25}

\en{We want to start from the classical definition of a
\term{computational method} 
(here and throughout bold typeface will be used for new terms)
from Donald Knuth's \textit{The Art of Computer Programming}~\cite{knuth}.
...
Suppose that execution function $\mathcal{F}$ is a piecewise-defined function
and it is defined for sets $s_0, s_1, \dots, s_m, \dots$ and
$D = s_0 \cup s_1 \cup \dots \cup s_m \cup \dots,
    \forall i, j \,\, i \neq j \Ra s_i \cap s_j = \varnothing$.
