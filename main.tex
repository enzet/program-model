...
$\forall d \in D_i \,\, f_i(d) = \mathcal{F}(d)$.
...
$\mathcal{P} = \langle F, D, D_I, D_T \rangle$,
where
\begin{itemize}
    \item $F = \{f_i\}$ is a set of function elements,
    \item $D = \{D_j\}$ is a superset of states,
    \item $D_I = D_0$ is a initial state,
    \item $D_T = \{D_k\}$ is a superset of terminal states.
\end{itemize}
