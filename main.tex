...
\subsublevel{Concrete semantics}

\term{Concrete semantics} is a definition of all data function elements $f^D_j$
used in program. \comment{Add connection with a system of commands.}
...
$X = \{x_k\}, x_k \in \mathcal{B}$ called \term{symbolic variables}.
